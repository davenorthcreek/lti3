...
public class AppTest {
	...
	public void setUp() {
		...
		try {
			...
			"oauth_callback%3Dabout%253Ablank%26oauth_consumer_key%3Djisc.ac.uk%26" + 
			"oauth_nonce%3D8fcb42eb8b4289efa3b7151dbef922d7%26" + 
			"oauth_signature_method%3DHMAC-SHA1%26oauth_timestamp%3D1484964741%26oauth_version%3D1.0%26" + 
			...
			// replace a couple so they match
			req.setParameter("oauth_consumer_key", "northcreek.ca");
			req.setParameter("oauth_timestamp", "1485017797");

			String param = req.getParameter("lti_message_type");
			
			System.out.println("message type is " + param);
